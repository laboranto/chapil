    ...
    <>
      ...
      <div className="content">
        ...
        <div className="section-advice">
          <p>차필에서 작성하신 데이터는 기본적으로 사용자의 기기 내부에 저장됩니다. 아래 '복구코드 백업' 기능을 통해 앱을 실행할 때마다 확인하여 마지막 백업으로부터 24시간이 지났으면 암호화된 데이터가 자동으로 서버에 전송되며, 코드 없이는 개발자를 포함해 아무도 열람할 수 없습니다.</p>
